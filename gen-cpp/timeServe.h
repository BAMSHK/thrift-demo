...
class timeServeIfSingletonFactory : virtual public timeServeIfFactory {
 public:
  timeServeIfSingletonFactory(const ::std::shared_ptr<timeServeIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::std::shared_ptr<timeServeIf> iface_;
};
...
class timeServe_getCurrtentTime_args {
 public:
  ...
  virtual ~timeServe_getCurrtentTime_args() noexcept;
...
class timeServe_getCurrtentTime_pargs {
 public:
  ...
  virtual ~timeServe_getCurrtentTime_pargs() noexcept;
...
class timeServe_getCurrtentTime_result {
 public:
  ...
  virtual ~timeServe_getCurrtentTime_result() noexcept;
  int32_t success;
...
class timeServe_getCurrtentTime_presult {
 public:
  ...
  virtual ~timeServe_getCurrtentTime_presult() noexcept;
  int32_t* success;
...
class timeServeClient : virtual public timeServeIf {
 public:
  timeServeClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  timeServeClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class timeServeProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  timeServeProcessor(::std::shared_ptr<timeServeIf> iface) :
    iface_(iface) {
...
class timeServeProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  timeServeProcessorFactory(const ::std::shared_ptr< timeServeIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::std::shared_ptr< timeServeIfFactory > handlerFactory_;
};

class timeServeMultiface : virtual public timeServeIf {
 public:
  timeServeMultiface(std::vector<std::shared_ptr<timeServeIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~timeServeMultiface() {}
 protected:
  std::vector<std::shared_ptr<timeServeIf> > ifaces_;
  timeServeMultiface() {}
  void add(::std::shared_ptr<timeServeIf> iface) {
...
class timeServeConcurrentClient : virtual public timeServeIf {
 public:
  timeServeConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  timeServeConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
